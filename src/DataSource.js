...
export default class DataSource
{
	...
	initLocation()
	{
		...
		loc['CADV'] = {};
		loc['CADV'].link = [];
		//loc['CADV'].link[0] = {name: 'C02', pos: [221,6,448]};
		loc['CADV'].position = {x: 0.47276688453159044, y: 0.3340213278293774};
		loc['CADV'].rotation = BABYLON.Tools.ToRadians(158);
		...
		loc['C01'].link[3] = {name: 'B01', pos: [20,15,499]};	
		...
		loc['B01'].link[2] = {name: 'CT', pos: [388,12,-313]};
		loc['B01'].link[3] = {name: 'KLF', pos: [-406,12,-290]};		
		...
		loc['B02'].rotation = BABYLON.Tools.ToRadians(265);
		...
		loc['CT'].rotation = BABYLON.Tools.ToRadians(265);
		
		//PLACEHOLDER
		loc['KLF'] = {};
		loc['KLF'].link = [];
		loc['KLF'].position = {x: 0.5931659213392959, y: 0.4773535145052173};
		loc['KLF'].rotation = BABYLON.Tools.ToRadians(265);
		...
		loc['E01'].rotation = BABYLON.Tools.ToRadians(158);

		//PLACEHOLDER
		loc['E02'] = {};
		loc['E02'].link = [];
		loc['E02'].position = {x: 0.5249398004815962, y: 0.6550854259832588};
		loc['E02'].rotation = BABYLON.Tools.ToRadians(158);

		//PLACEHOLDER
		loc['E03'] = {};
		loc['E03'].link = [];
		loc['E03'].position = {x: 0.4968466918931315, y: 0.7342047930283224};
		loc['E03'].rotation = BABYLON.Tools.ToRadians(158);

		//PLACEHOLDER
		loc['SBR'] = {};
		loc['SBR'].link = [];
		loc['SBR'].position = {x: 0.42116729732828806, y: 0.5685127852310514};
		loc['SBR'].rotation = BABYLON.Tools.ToRadians(158);
